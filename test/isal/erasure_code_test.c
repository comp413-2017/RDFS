 ...
 *
 * This test is not actually run, but it is included as a sample of how this
 * library should be used in actual code.
 */
...
int main(int argc, char *argv[]) {
  ...
  pEncoder = malloc(sizeof(IsalEncoder));
  ...
  pDecoder = malloc(sizeof(IsalDecoder));
